...
import { RotateCw, Lock, Mail, Eye, EyeOff, ShieldCheck, Cloud, CheckCircle, AlertCircle, User } from 'lucide-react';
        ...
        <div className="relative z-10 bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 mt-12">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-primary-100 opacity-90">Do agendamento ao pós-operatório, tudo sob controle.</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-slate-500">
              {isSignUp
                ...
                : 'Entre com suas credenciais NAVEGAR 360.'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all transform hover:scale-[1.01] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center">
            ...
            <button
              ...
              className="ml-1 text-sm font-bold text-primary-600 hover:text-primary-500"
            >
